<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FECredit_Reset.aspx.cs" Inherits="FECredit_Reset" %>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnReset" runat="server" Text="Reset Password"
                                            OnClick="btnReset_Click" ValidationGroup="submitClick" CssClass="fe-col w3-button w3-block w3-green w3-section w3-padding" /></td>
                                </tr>
                                <tr>
