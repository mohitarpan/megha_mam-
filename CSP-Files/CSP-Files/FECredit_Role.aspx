<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FECredit_Role.aspx.cs" Inherits="FECredit_Role" %>
            ...
            <div class="w3-container w3-margin w3-white" style="min-height: 38em;">
                <div class="w3-modal-content w3-animate-zoom w3-border" style="max-width: 500px; margin-top: 5em;">
                    ...
                    <div class="w3-section w3-container" id="divRole">
                        ...
                        <asp:TextBox ID="txtRoleId" runat="server" MaxLength="8" CssClass="w3-input w3-border w3-margin-bottom"></asp:TextBox>
                        <asp:RegularExpressionValidator ID="revRoleId" runat="server" ControlToValidate="txtRoleId"
                        ...
                        <asp:RequiredFieldValidator ID="rfvRoleId" runat="server"
                            ErrorMessage="Please enter Role Id" ControlToValidate="txtRoleId"
                        ...
                        <asp:TextBox ID="txtRoleDesc" runat="server" MaxLength="60" CssClass="w3-input w3-border w3-margin-bottom"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvRoleDesc" runat="server"
                            ErrorMessage="Please enter Role Description" ControlToValidate="txtRoleDesc"
                            Display="None" ForeColor="Red" SetFocusOnError="True" ValidationGroup="submitClick"></asp:RequiredFieldValidator>
                        <asp:RegularExpressionValidator ID="revRoleDesc" runat="server" ControlToValidate="txtRoleDesc"
                            ForeColor="Red" SetFocusOnError="True" Display="None"
                            ErrorMessage="No Special characters in Role Description"
                            ValidationExpression="^[\sa-zA-Z0-9]*$" ValidationGroup="submitClick">
                        </asp:RegularExpressionValidator>
                        <asp:ValidationSummary ID="vsErrorList" runat="server" HeaderText="Following error occurs: " ShowMessageBox="false" DisplayMode="BulletList" ShowSummary="true" BackColor="Snow"
                        ...
                        <div>
                            ...
                            <table>
                                <tr>
                                    <td>
                                        <asp:Button ID="btnSave" runat="server" Text="Save" ValidationGroup="submitClick"
                                            OnClick="btnSave_Click" CssClass="fe-col w3-button w3-block w3-green w3-section w3-padding" />
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <asp:Label ID="lbl_error" runat="server" ForeColor="Red" Visible="False" Text="Role ID already exists. Please create with different Role ID"></asp:Label>
                                        <asp:Label ID="lbl_success" runat="server" ForeColor="Green" Visible="False" 
                                            Text="Role creation to the CRE successful!!" ></asp:Label>
                    ...
                    <table border="3" align="center" style="margin-top: 0.5px;">
                        <tr>
                            <th id="Update" style="background-color: #008848">Roles</th>
                        </tr>
                        <tr>
                            <td>
                                <asp:GridView ID="gdvRole" runat="server" AutoGenerateColumns="false"
                                    ...
                                    EmptyDataText="No records has been added." Width="450" OnRowDataBound="gdvRole_RowDataBound">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="ROLE ID" ItemStyle-Width="150">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgdvRoleId" runat="server" Text='<%# Eval("FECREDIT_ROLEID") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtgdvRoleId" Enabled="false" runat="server" MaxLength="8" Text='<%# Eval("FECREDIT_ROLEID") %>' Width="140"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Role Description" ItemStyle-Width="150">
                                            <ItemTemplate>
                                                <asp:Label ID="lblgdvRoleDesc" runat="server" Text='<%# Eval("FECREDIT_ROLEDESC") %>'></asp:Label>
                                            </ItemTemplate>
                                            <EditItemTemplate>
                                                <asp:TextBox ID="txtgdvRoleDesc" runat="server" MaxLength="60" Text='<%# Eval("FECREDIT_ROLEDESC") %>' Width="140"></asp:TextBox>
                                            </EditItemTemplate>
                                        </asp:TemplateField>
