<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FECredit_ChangePass.aspx.cs" Inherits="FECredit_ChangePass" %>
    ...
    <form class="w3-container" runat="server">
        <div class="w3-container">
            <div class="w3-display-container w3-white w3-padding">
                ...
                <div class="w3-content w3-third">
                    <span class="w3-right w3-padding w3-hide-small" id="spTopLinks" runat="server">
            ...
            <div class="w3-container w3-margin w3-white" style="min-height: 38em;">
                <div class="w3-modal-content w3-animate-zoom w3-border" style="max-width: 400px; margin-top: 5em;">
                    ...
                    <div class="w3-section w3-container" id="divLogin">
                        ...
                        <asp:TextBox ID="txtOldPwd" runat="server" TextMode="Password" MaxLength="15" CssClass="w3-input w3-border w3-margin-bottom"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtNewPwd" runat="server" TextMode="Password" MaxLength="15" CssClass="w3-input w3-border w3-margin-bottom"></asp:TextBox>
                        ...
                        <asp:TextBox ID="txtConfirmPwd" runat="server" TextMode="Password" MaxLength="15" CssClass="w3-input w3-border w3-margin-bottom"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvConfirmPwd" runat="server"
                            ErrorMessage="Please re-enter password to confirm"
                            ControlToValidate="txtConfirmPwd" Display="None" ForeColor="Red"
                            SetFocusOnError="True" ValidationGroup="submitClick"></asp:RequiredFieldValidator>
                        <asp:CompareValidator ID="cmvConfirmPwd" runat="server"
                            ControlToCompare="txtNewPwd" ControlToValidate="txtConfirmPwd"
                            Display="None" ErrorMessage="New and confirm password didn't match"
                            ForeColor="Red" SetFocusOnError="True" ValidationGroup="submitClick"></asp:CompareValidator>
                                ...
                                <tr>
                                    <td>
                                        <asp:Button ID="btnChange" runat="server" Text="Change Password"
                                            OnClick="btnChange_Click" ValidationGroup="submitClick" CssClass="fe-col w3-button w3-block w3-green w3-section w3-padding" />
                                        <asp:Button ID="btnGoBack" runat="server" Text="Go Back"
                                            OnClick="btnGoBack_Click" CssClass="fe-col w3-button w3-block w3-green w3-section w3-padding" />
                                        
                                        <%--<a id="aGoBack" runat="server" href="FECredit_Login.aspx" onclick="" style="color: red">Go Back</a>--%>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <asp:Label ID="lblStatus" runat="server" Text=""></asp:Label>
                                        <asp:Label ID="lbl_error" runat="server" ForeColor="Red" Visible="False" Text="InValid User ID or Password. Enter correct details to Change Password"></asp:Label>
                                        <asp:Label ID="lbl_success" runat="server" ForeColor="Green" Visible="False" Text="Password changed successfully!!"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </div>
