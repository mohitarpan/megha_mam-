<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FD_Admin.aspx.cs"
Inherits="FD_Admin" %>
  ...
  <body>
    <form id="form1" runat="server">
      ...
      <div id="updateUserDiv" runat="server">
        ...
        <!-- here give name the tave-->
        <table class="tave" border="3" align="center">
          <tr>
            <th id="Update">Update\Delete Existing User</th>
            <!-- here give id name ADD-new and class name -->
            <th id="ADD_new">
              <a class="Add_new_user" href="FECredit_NewUser.aspx"
                >Add New User</a
              >
            </th>
          </tr>
              ...
              <contenttemplate>
                ...
                >
                  <Columns>
                    ...
                    <asp:TemplateField HeaderText="Role" ItemStyle-Width="150">
                      <ItemTemplate>
                        <asp:Label
                          ID="lblrole"
                          runat="server"
                          ToolTip='<%# Eval("FECREDIT_ROLE") %>'
                          Text='<%# Eval("FECREDIT_ROLE") %>'
                        ></asp:Label>
                      </ItemTemplate>
                      <EditItemTemplate>
                        <asp:DropDownList
                    ...
                    >
                      <ItemTemplate>
                        <asp:Label
                          ID="lbldisabled"
                          runat="server"
                          Text='<%# Eval("FECREDIT_IS_DISABLED") %>'
                        ></asp:Label>
                      </ItemTemplate>
                      <EditItemTemplate>
                        <asp:DropDownList
                    ...
                    >
                      <ItemTemplate>
                        <asp:Label
                          ID="lbldate"
                          runat="server"
                          Text='<%# Eval("FECREDIT_LOGIN_DATE1") %>'
                        ></asp:Label>
                      </ItemTemplate>
                      <EditItemTemplate>
                        <asp:TextBox
                    ...
                    <asp:TemplateField
                      HeaderText="Installation ID"
                      ItemStyle-Width="150"
                    >
                      <ItemTemplate>
                        <asp:Label
                          ID="lblInstallationId"
                          runat="server"
                          Text='<%# Eval("FECREDIT_InstallationID") %>'
                        ></asp:Label>
                      </ItemTemplate>
                      <EditItemTemplate>
                        <asp:TextBox
                          ID="txtInstallationId"
                          runat="server"
                          MaxLength="60"
                          Text='<%# Eval("FECREDIT_InstallationID") %>'
                          Width="140"
                    ...
                    >
                      <ItemTemplate>
                        <asp:Label
                          ID="lblCreationDate"
                          runat="server"
                          Text='<%# Eval("FECREDIT_CREATIONDATE") %>'
                        ></asp:Label>
                      </ItemTemplate>
                      <EditItemTemplate>
                        <asp:TextBox
