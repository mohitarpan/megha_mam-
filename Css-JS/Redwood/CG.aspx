<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FECreditCG.aspx.cs" Inherits="FECreditCG" MaintainScrollPositionOnPostback="true" %>
...
<link rel="strlesheet" href="APIs.css"><!-- here is external css file -->
...
<script type="text/javascript" src="APIs.js"></script><!-- here external js file -->
<%-- coll script --%>
                ...
                <div class="w3-card-2 w3-twothird">
                    ...
                    <div runat="server" id="divInformation" visible="true">
                        ...
                        <div class="w3-content w3-border fe-col" id=".fe-col">
                            ...
                            <button id="btnCG" runat="server" class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event, 'CG')">Contactability Grid</button>
                            <button id="btnApi" runat="server" class="w3-bar-item w3-button tablink" onclick="openCity(event, 'API')">3rd Party APIs</button>
                        </div>

                        <div id="CG" class="w3-content city">
                            <div class="w3-content">
                                <div class="w3-container w3-card w3-white w3-margin-bottom">
                                    <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-user fa-fw w3-margin-right w3-xxlarge w3-text-fe-col"></i>
                                        <asp:Label ID="lblCG" runat="server"></asp:Label></h2>
                                    <div class="w3-container w3-margin-bottom">
                                        <p class="w3-opacity">
                                            <b>National ID :  
                                            <asp:Label ID="lblCGNid" runat="server">234455557</asp:Label></b>
                                        </p>
                                        <div class="w3-content w3-white w3-padding">
                                            <table runat="server" id="tblBulkCG">
                                                <tr>
                                                    <td>
                                                        <asp:FileUpload runat="server" ID="fileUploadCG" /></td>
                                                    <td>
                                                        <asp:Button ID="btnCGExport" runat="server" OnClick="btnCGExport_Click" Text="Export" CssClass="fe-col w3-button w3-block w3-green w3-section w3-padding"></asp:Button>
                                                    </td>
                                                </tr>
                                                <%-- <tr>
                                                    <td colspan="2">
                                                        <asp:Button ID="ButtonCG" runat="server" Text="Fetch Contactibility Grid" OnClick="cgCalls" CssClass="fe-col w3-button w3-block w3-green w3-section w3-padding" />
                                                    </td>
                                                </tr>--%>
                                                <tr>
                                                    <td colspan="2">
                                            ...
                                            <asp:GridView ID="grdCG" runat="server"
