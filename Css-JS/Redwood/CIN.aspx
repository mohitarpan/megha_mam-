<%@ Page Language="C#" AutoEventWireup="true" CodeFile="FECreditCIN.aspx.cs" Inherits="FECreditCIN" MaintainScrollPositionOnPostback="true" %>
...
<link rel="stylesheet" href="APIs.css"><!-- here external css file -->
                ...
                <div class="w3-card-2 w3-twothird">
                    ...
                    <div runat="server" id="divInformation" visible="true">
                        ...
                        <div class="w3-content w3-border fe-col" id=".fe-col" style="max-width: 1400px;">
                            ...
                            <button id="btnCIN" runat="server" class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event, 'CIN')">Customer Interaction</button>
                        ...
                        <div id="CIN" class="w3-content city">
                            <div class="w3-content">
                                <div class="w3-container w3-card w3-white w3-margin-bottom">
                                    <h2 class="w3-text-grey w3-padding-16"><i class="fa fa-user fa-fw w3-margin-right w3-xxlarge w3-text-fe-col"></i>
                                        <asp:Label ID="lblCINCustomer" runat="server"></asp:Label></h2>
                                    <div class="w3-container w3-margin-bottom">
                                        <p class="w3-opacity">
                                            <b>National ID :  
                                            <asp:Label ID="lblCINNid" runat="server">234455557</asp:Label></b>
                                        </p>
                                        <div class="w3-content w3-white w3-padding">
                                            <asp:GridView ID="grdCIN" runat="server"
                                                ...
                                                Width="100%" OnRowDataBound="grdCIN_RowDataBound">
